...
window.onload = function () {
        ...
        //window.open("https://www.car2go.com/api/authorize?oauth_token=" + token, "test man", "_blank, width=350, height=300, top=270, left=450" );
        // pass token to getVerifier.html
        var webWindow = document.getElementById('myFrame').src = 'https://www.car2go.com/api/authorize?oauth_token=' + token;
